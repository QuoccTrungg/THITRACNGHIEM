...
namespace TRACNGHIEM
{
    public partial class Form_DangNhap : Form
    {
        ...
        private void btn_DangNhap_Click(object sender, EventArgs e)
        {
            ...
            Program.conn.Close();
            Program.frmChinh.rib_backup_restore.Visible = Program.frmChinh.rib_role_login.Visible = Program.frmChinh.ribbonPage2.Visible = true;
            ...
            Program.frmChinh.btn_soanch.Enabled= true;
