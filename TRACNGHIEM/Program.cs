...
namespace TRACNGHIEM
{
    static class Program
    {
        ...
        public static String connstr_publisher = "Data Source=LAPTOP-UEL9U0VQ;Initial Catalog=TRACNGHIEM;Integrated Security=True";
        public static string Dbname = "TRACNGHIEM";
